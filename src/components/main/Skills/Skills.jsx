...
function Skills() {
  ...
  const filteredProgressBarData = progressBarData.filter(
      ...
      <div className="col-sm-12 col-md-10 col-lg-8 mx-auto">
        <div className="mb-4">
          <div className="row text-center font-secondary fs-5">
            <SkillsTopic
              text="Frontend"
              onClick={() => handleItemClick(0, "Frontend")}
            />
            <SkillsTopic
              text="Backend"
              onClick={() => handleItemClick(1, "Backend")}
            />
            <SkillsTopic
              text="Technology"
              onClick={() => handleItemClick(2, "Technology")}
            />
          </div>
          <Slider
        ...
        <div className="mt-md-5 mt-3 text-center position-relative">
          <div className="legend-line">
            <LegendComponent position="0%" />
            <LegendComponent position="25%" text="Basics" />
            <LegendComponent position="50%" text="Intermediate" />
            <LegendComponent position="75%" text="Advanced" />
            <LegendComponent position="100%" text="Expert" />
          </div>
        </div>
      </div>
    </div>
