        ...
        <div className="container">
            <div className="d-flex flex-wrap justify-content-between align-items-center py-3 my-4 border-top">
                <div className="col-md-4 d-flex align-items-center ps-2">
                    <p className="mb-3 mb-md-0">© Marco Ribeiro's Portfolio</p>
                </div>
                <ul className="nav col-md-4 justify-content-end list-unstyled d-flex">
                    <li>
                        <a href="https://github.com/krathus88" style={{ color: "inherit" }} target="_blank" rel="noreferrer">
                    ...
                    <li className="ms-3">
                        <a href="https://www.linkedin.com/in/marco-ribeiro-663391204/" style={{ color: "inherit" }} target="_blank" rel="noreferrer">
